...
public class CardGameManager : MonoBehaviourPunCallbacks, IOnEventCallback
{
    ...
    private BattleCardVisual _draggingCard;
    ...
    private List<BattleCardVisual> _choosedCards
    {
        get
        {
            return ChoosedField.GetComponentsInChildren<BattleCardVisual>().ToList();
        }
    }
    ...
    public bool CanFocus(BattleCardVisual cardVisual)
    {
    ...
    public void CardClicked(BattleCardVisual cardVisual)
    {
    ...
    public void DragCard(BattleCardVisual cardVisual)
    {
        CardsLayout cl = cardVisual.transform.parent.GetComponent<CardsLayout>();
    ...
    private void GiveCardTo(BattleCard card, Player p, CardPosition position)
    {
